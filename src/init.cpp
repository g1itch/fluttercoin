...
//        CTxDB().Close();
        ...
        fExit = true;
#ifndef QT_GUI
        // ensure non-UI client gets exited here, but let fluttercoin-Qt reach 'return 0;' in bitcoin.cpp
        exit(0);
#endif
    }
    else
...
if (firstRunCheck() == 0)
    ...
    // requested to kill fluttercoin-qt during the last operation. If so, exit.
